document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    ...
    .addEventListener("submit", function (e) {
      ...
      fetch(`https://phase-1-project-server.vercel.app/headteachers`)
  ...
  document
    ...
    .addEventListener("submit", function (e) {
      ...
      const userType = document.querySelector(
        'input[name="reg-userType"]:checked'
      ).value;
  ...
  document
    ...
    .addEventListener("click", function () {
      document.getElementById("headteacher-dashboard-container").style.display =
        "none";
    ...
    .addEventListener("submit", function (e) {
      ...
      fetch("https://phase-1-project-server.vercel.app/teachers", {
        ...
        .then((data) => {
          ...
          document.getElementById("add-teacher-container").style.display =
            "none";
          document.getElementById(
            "headteacher-dashboard-container"
          ).style.display = "block";
  ...
  document
    .getElementById("back-to-dashboard-from-add-teacher")
    .addEventListener("click", function () {
  ...
  // Show admission form
  document
    .getElementById("show-admission-form")
    .addEventListener("click", function () {
      document.getElementById("headteacher-dashboard-container").style.display =
        "none";
  ...
  document
    ...
    .addEventListener("submit", function (e) {
      ...
      const admissionNumber = document.getElementById(
      ...
      const guardianResidence =
        document.getElementById("guardian-residence").value;
      ...
      formData.append(
        "transferLetter",
        document.getElementById("transfer-letter").files[0]
      );
      formData.append(
        "birthCertificate",
        document.getElementById("birth-certificate").files[0]
      );
      formData.append(
        "learnerPhoto",
        document.getElementById("learner-photo").files[0]
      );
  ...
  document
    .getElementById("back-to-dashboard-from-admission")
    .addEventListener("click", function () {
      document.getElementById("admission-container").style.display = "none";
      document.getElementById("headteacher-dashboard-container").style.display =
        "block";
  ...
  document
    .getElementById("logout-button-teacher")
    .addEventListener("click", function () {
      localStorage.removeItem("role");
      document.getElementById("teacher-dashboard-container").style.display =
        "none";
      document.getElementById("login-container").style.display = "block";
    });
